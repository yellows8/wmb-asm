ninchdl-listext v1.0 by yellowstar6. Utility to decrypt, decompress, read and dump info and URLs from Nintendo Channel download lists, either locally from HD, or directly from the servers.

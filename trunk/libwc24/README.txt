...
Wc24app adds anonymous tracking info to the installed entries' URLs for logging server access. This only contains the consoleID, which is unique to each Wii. Currently this is only enabled for the test entries.
